...
{
  ros::init(argc, argv, "matrix_storer_fastall");
...
final_name[27].data ="16";
  ...
  //fast 1 i=no_sp...no_p , j= 0...no_sp  //from p to sp
  //fast 2 i=0...no_p-1 , j= 0...no_p-1  //sp to sp
  //slow 1 i=0..no_sp-1, j= no_sp... no_p
  //slow 2

  //optimisation
  //fast i=0...no_p j= 0...no_sp //point to sp + sp to sp
  ...
  rosbag::Bag bag;
  bag.open("matrix_storer_fastall.bag", rosbag::bagmode::Write);
