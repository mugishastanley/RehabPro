...
// Read data from 2 bag files
//Read from slow profile if dest is a point
//else reqd from fast profile
...
int main(int argc, char** argv)
{
  ...
  */
  ros::init(argc, argv, "matrix_reader_28");
  ...
  //read the time stamp and write them to plan_array
  ...
  foreach(rosbag::MessageInstance const m, view)
  {
      ...
      // Store trajectories data for slow profile
