...
if("TRUE" STREQUAL "TRUE")
  set(ur5_e_moveit_config_SOURCE_PREFIX /home/adminuser/ws_moveit3/src/universal_robot/ur5_e_moveit_config)
  set(ur5_e_moveit_config_DEVEL_PREFIX /home/adminuser/ws_moveit3/devel)
  ...
  set(ur5_e_moveit_config_INSTALL_PREFIX /home/adminuser/ws_moveit3/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur5_e_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adminuser/ws_moveit3/src/universal_robot/ur5_e_moveit_config/${idir}'.  ${_report}")
    endif()
