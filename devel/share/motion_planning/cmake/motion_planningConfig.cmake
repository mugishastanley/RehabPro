...
if("TRUE" STREQUAL "TRUE")
  set(motion_planning_SOURCE_PREFIX /home/adminuser/ws_moveit3/src/motion_planning)
  set(motion_planning_DEVEL_PREFIX /home/adminuser/ws_moveit3/devel)
  ...
  set(motion_planning_INSTALL_PREFIX /home/adminuser/ws_moveit3/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adminuser/ws_moveit3/src/motion_planning/${idir}'.  ${_report}")
    endif()
