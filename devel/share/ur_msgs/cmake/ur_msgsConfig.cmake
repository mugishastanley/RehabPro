...
if("TRUE" STREQUAL "TRUE")
  set(ur_msgs_SOURCE_PREFIX /home/adminuser/ws_moveit3/src/universal_robot/ur_msgs)
  set(ur_msgs_DEVEL_PREFIX /home/adminuser/ws_moveit3/devel)
  set(ur_msgs_INSTALL_PREFIX "")
  set(ur_msgs_PREFIX ${ur_msgs_DEVEL_PREFIX})
else()
  set(ur_msgs_SOURCE_PREFIX "")
  set(ur_msgs_DEVEL_PREFIX "")
  set(ur_msgs_INSTALL_PREFIX /home/adminuser/ws_moveit3/install)
...
if(NOT "/home/adminuser/ws_moveit3/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adminuser/ws_moveit3/src/universal_robot/ur_msgs/${idir}'.  ${_report}")
    endif()
